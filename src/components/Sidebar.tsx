        ...
        <aside className='w-64 border-r bg-white flex flex-col justify-between'>
            <div>
                <div className='p-2'>
                    <div className='flex items-center gap-2 p-2'>
                        <div className='flex aspect-square w-8 h-8 items-center justify-center rounded-lg bg-blue-600 text-white'>
                        ...
                        {openBoards && activeWorkspace && (
                            <SidebarMenuSub className='mx-[0.9rem] flex min-w-0 translate-x-px flex-col gap-1 border-l border-gray-200 px-2.5 py-0.5'>
                                {(activeWorkspace.boards ?? []).length > 0 ? (
                                    ...
                                    <div className='text-xs text-gray-400 px-2 py-1'>No boards yet</div>
                                )}
                            </SidebarMenuSub>
                        )}
                    </SidebarGroup>
            ...
            <div className='p-4 border-t flex items-center gap-3'>
                ...
                <div className='text-sm leading-tight'>
                    <div className='font-medium text-gray-800'>{user?.username || 'User'}</div>
