        ...
        <Card className="shadow-sm border-none bg-white rounded-2xl w-full">
            <CardContent className="p-8">
                <div className="mb-6 border-b pb-4">
                    ...
                    <p className="text-sm text-gray-500">Boards you have archived. You can restore them here.</p>
                </div>
                        ...
                        {archivedBoards.map((board: any) => (
                            <div key={board.id} className="flex items-center justify-between p-4 border rounded-lg bg-gray-50">
                                ...
                                <Button
                                    ...
                                    disabled={reopenMutation.isPending && reopenMutation.variables === board.id}
                                    className="flex items-center gap-2 shrink-0"
                                >
                                    {reopenMutation.isPending && reopenMutation.variables === board.id ? (
