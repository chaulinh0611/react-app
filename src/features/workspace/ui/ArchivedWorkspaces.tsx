...
export function ArchivedWorkspaces() {
    ...
    const { data: workspaces, isLoading, isError } = useQuery({
        ...
        queryFn: async () => {
            ...
            return res.data; // Array of workspaces
        }
    });
        ...
        <Card className="shadow-sm border-none bg-white rounded-2xl w-full">
            <CardContent className="p-8">
                <div className="mb-6 border-b pb-4">
                    ...
                    <p className="text-sm text-gray-500">Workspaces you have archived. You can restore them here.</p>
                </div>
                ...
                {archivedWorkspaces.length === 0 ? (
                    ...
                    <div className="space-y-3">
                        {archivedWorkspaces.map((ws: any) => (
                            <div key={ws.id} className="flex items-center justify-between p-4 border rounded-lg bg-gray-50">
                                <div>
                                ...
                                >
                                    {unarchiveMutation.isPending && unarchiveMutation.variables === ws.id ? (
