...
export default function WorkspacePage() {
  ...
  const fetchMembersByBoardId = useBoardMemberStore(
    (s) => s.fetchMembersByBoardId
  )
  ...
  const workspaceTitle =
    workspaceBoards[0]?.workspace?.title ?? 'Workspace'

  const workspaceDescription =
    workspaceBoards[0]?.description ?? 'Workspace description'
